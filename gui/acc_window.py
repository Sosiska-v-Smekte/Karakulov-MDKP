...
class AccountantWorkspace(QWidget):
    ...
    def add_work_type(self):
        # TODO: Открыть модальное окно с QLineEdit для имени и QDoubleSpinBox для ставки,
        # затем создать новый объект WorkType и сохранить в базу.
        print("Открытие окна добавления типа работы...")
